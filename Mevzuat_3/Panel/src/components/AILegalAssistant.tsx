...
Daha detaylı bilgi için lütfen durumunuzu açıklayın.`,
    ...
    if (lowerMessage.includes('telefon') || lowerMessage.includes('iletişim') || lowerMessage.includes('destek')) {
      return {
        id: Date.now().toString(),
        type: 'assistant',
        content: `📱 **Hukuki Destek İletişim**

7/24 hukuki destek alabilirsiniz!
...
**💬 Kullanım:**
1. Telefon numaramızı kaydedin
2. "Merhaba" diyerek başlayın
...
4. **📱 Telefon Desteği** - "destek" yazın
...
- "Tazminat davası dilekçesi"`,
  ...
  const quickActions = [
    ...
    { icon: Phone, text: 'Telefon Destek', action: () => setInputMessage('destek') }
  ];
    ...
    <div className="flex flex-col h-full bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="mt-2 text-xs text-gray-500 dark:text-gray-400">
          💡 İpucu: "içtihat ara", "dilekçe hazırla", "destek" gibi komutları kullanabilirsiniz
        </div>
      </div>
    </div>
  );
